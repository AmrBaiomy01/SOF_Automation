...
public class AccountVerficationTest extends BasicTest{
	...
	/*@Test(description="Validate Account verification Functionality",priority=1,dataProvider="AccountVerificationDataProvider")
	public static void accountVerification(AccountPojo accountverificationobj)
	{
		...
		String actual = accountverfication.accountVerfication(accountverificationobj);
		
		System.out.println(accountverificationobj.getExpectedMessage());
		
	}*/
	
	@Test(description="Validate Account verification Functionality",priority=1,dataProvider="AccountVerficationDataProvider")
